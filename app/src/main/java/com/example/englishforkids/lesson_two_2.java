...
public class lesson_two_2 extends AppCompatActivity implements View.OnDragListener{
    TextView tv_1;
    TextView tv_2;
    TextView tv_3;
    TextView tv_4;
    ...
    private void congratsTheBoy(){
        ...
        MainActivity.pref.edit().putInt(MainActivity.strCurrLevel,4).apply();
        ...
        alertDialog.setPositiveButton(R.string.nextLevel, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                startActivity(new Intent(lesson_two_2.this,MainActivity.class));
            }
        });
    ...
    private void playCurrWord()
    {
        ...
        if(result==AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
            mediaPlayer = MediaPlayer.create(lesson_two_2.this,arrayList.get(currWord).getAudioId());
            mediaPlayer.start();
        ...
        switch (action)
        {
            ...
            case DragEvent.ACTION_DROP:
                ...
                if(((TextView)v).getText().toString().matches(arrayList.get(currWord).getWord()))
                {
                    ...
                    {
                        releaseMedia();
                        mediaPlayer=MediaPlayer.create(lesson_two_2.this,R.raw.yahoo);
                        mediaPlayer.start();
                        mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                            @Override
                            public void onCompletion(MediaPlayer mediaPlayer) {
                    ...
                    if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                        releaseMedia();
                        mediaPlayer = MediaPlayer.create(lesson_two_2.this, R.raw.wrong_answer);
                        mediaPlayer.start();
                        ((TextView)findViewById(R.id.wrong_tv)).setVisibility(View.VISIBLE);
                        mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                            @Override
                            public void onCompletion(MediaPlayer mediaPlayer) {
                                ((TextView)findViewById(R.id.wrong_tv)).setVisibility(View.INVISIBLE);
                                releaseMedia();
                            }
                        });
                    }
