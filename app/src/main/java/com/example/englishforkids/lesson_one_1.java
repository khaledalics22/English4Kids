...
public class lesson_one_1 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
            ...
            public void onClick(View view) {
                ...
                if(result==AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    if(RBtn.getText().toString().toLowerCase().matches(arrayList.get(currWord).getWord().toLowerCase())){
                        tvWrong.setVisibility(View.INVISIBLE);
                        mediaPlayer = MediaPlayer.create(lesson_one_1.this, R.raw.yahoo);
                         mediaPlayer.start();
                        ...
                        mediaPlayer = MediaPlayer.create(lesson_one_1.this, R.raw.wrong_answer);
                        mediaPlayer.start();
                        mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                            @Override
                            public void onCompletion(MediaPlayer mediaPlayer) {
    ...
    private void playCurrWord()
    {
        ...
        if(result==AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
            mediaPlayer = MediaPlayer.create(lesson_one_1.this,arrayList.get(currWord).getAudioId());
            mediaPlayer.start();
            mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                @Override
                public void onCompletion(MediaPlayer mediaPlayer) {
    ...
    private void congratsTheBoy(){
        ...
        alertDialog.setPositiveButton(R.string.nextLevel, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    startActivity(new Intent(lesson_one_1.this,MainActivity.class));
            }
        });
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        switch (menuItem.getItemId())
        {
            case R.id.level_nav_1:
                startActivity(new Intent(lesson_one_1.this, lesson_one_1.class));
                Toast.makeText(lesson_one_1.this,R.string.level_1,Toast.LENGTH_SHORT).show();
                break;

            case R.id.level_nav_2:
                startActivity(new Intent(lesson_one_1.this, lesson_one_2.class));
                Toast.makeText(lesson_one_1.this,R.string.level_2,Toast.LENGTH_SHORT).show();
                break;

            case R.id.level_nav_3:
                startActivity(new Intent(lesson_one_1.this, lesson_two_1.class));
                Toast.makeText(lesson_one_1.this,R.string.level_3,Toast.LENGTH_SHORT).show();
                break;

            case R.id.level_nav_4:
                startActivity(new Intent(lesson_one_1.this, lesson_two_2.class));
                Toast.makeText(lesson_one_1.this,R.string.level_4,Toast.LENGTH_SHORT).show();
                break;
        }
        return true;
    }
